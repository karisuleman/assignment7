...
function Pokemon:levelUp()
    ...
    -- print("Current Experience: " .. self.expToLevel )
    -- self.expToLevel = self.level * self.level * 5 * 0.75
    -- print("New Experience: " .. self.expToLevel )
    
    local HPIncrease, attackIncrease, defenseIncrease, speedIncrease = self:statsLevelUp()
        -- print out stuff from return value
        -- print("HPIncrease:  " .. tostring(HPIncrease))
        -- print("attackIncrease:  " .. tostring(attackIncrease))
        -- print("defenseIncrease:  " .. tostring(defenseIncrease))
        -- print("speedIncrease:  " .. tostring(speedIncrease))
        -- print("-----------------------------------------"  )
