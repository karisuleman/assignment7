...
function TakeTurnState:init(battleState)
    ...
    -- KARI ADDED * 10000
    if self.playerPokemon.speed * 10000 > self.opponentPokemon.speed then
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        function()
                            ...
                            -- use this to access existing values 
                            local healthOutput = 'Health: ' .. self.playerPokemon.HP-HPIncrease .. " + " .. HPIncrease .. " = " .. self.playerPokemon.HP
                            local attackOutput = 'Attack: ' .. self.playerPokemon.attack-attackIncrease .. " + " .. attackIncrease .. " = " .. self.playerPokemon.attack
                            local defenseOutput = 'Defense: ' .. self.playerPokemon.defense-defenseIncrease .. " + " .. defenseIncrease .. " = " .. self.playerPokemon.defense
                            local speedOutput = 'Speed: ' .. self.playerPokemon.speed-speedIncrease .. " + " .. speedIncrease .. " = " .. self.playerPokemon.speed

                            -- This is where we want to show our stats! 

                            gStateStack:push(MenuState({healthOutput, attackOutput, defenseOutput, speedOutput},
                            function()
                                self:fadeOutWhite()
                                -- gStateStack:pop()
